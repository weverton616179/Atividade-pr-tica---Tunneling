"""
Aplicação Cliente do Chat Criptografado.
Conecta ao servidor, realiza handshake de chaves públicas RSA
...
def main():
    print("=" * 60)
    print("  CHAT CRIPTOGRAFADO COM RSA - MODO CLIENTE")
    print("=" * 60)
    ...
    try:
        ...
        # Recebe a chave pública do servidor primeiro
        ...
        print(f"\n[!] Não foi possível conectar ao servidor {HOST}:{PORTA}.")
